<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="interviewQuestions.aspx.cs" Inherits="Modules_interviewQuestions" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <p class="myHeadingStyle">18. What the virtual keyword for?</p>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="question40" class="panel-collapse collapse p-indent">
                    <div class="panel-body">
                        Mock objects are simulated objects that mimic the behavior of real objects in controlled ways.  It is useful to create mocks, or fakes, in situations where it is impracticle
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="question24" class="panel-collapse collapse p-indent">
                    <div class="panel-body">
                        <ol>
                            <li>Use the formula for the Sum of the first n integers = n*(n + 1) / 2 to get the expected value.
                            </li>
                            <li>Loop thru the list to calculate the actual sum. 
                            </li>
                            <li>Subtract the actual value from the expected value, the result is your missing integer.
                            </li>
                        </ol>
