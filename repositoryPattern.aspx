...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="myHeadingStyle">Web API: The Repository & Unit of Work Design Patterns<br />
                </h1>
            </div>
        </div>
        <hr />
    ...
    <p class="p-indent">
        In this example we will implement the Repository design pattern as follows: first we will create the Interface that will define our <b>Generic Repository</b>,
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <p class="p-indent">First we create the IRepository interface which has a generic constraint and simply defines a set of CRUD 
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <p class="p-indent">Now the Repository class, which also has a generic constraint, provides the <b>implementation</b> of the CRUD operations.</p>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <p class="p-indent">
                    To handle database transactions we create a Unit of Work class which will allow us define our various repositories as well as commit transactions resulting from the CRUD operations. 
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="code">
                    ...
                    <span class="Namespace">namespace</span>&nbsp;ApiCrudDemo.Repository<br />
                    {<br />
                    &nbsp;&nbsp;&nbsp;&nbsp;<span class="Modifier">public</span>&nbsp;<span class="ReferenceType">class</span>&nbsp;UnitOfWork&nbsp;:&nbsp;DbContext,&nbsp;IUnitOfWork<br />
                    &nbsp;&nbsp;&nbsp;&nbsp;{<br />
    ...
    <br />
    <%--<h3 class="myHeadingStyle">Web API Controller</h3>

    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <p class="p-indent">
                    The Web API Customers Controller will perform CRUD operations, passing data between the database and the view via the angular controller
                    and vice versa.
                </p>
            </div>
        </div>
